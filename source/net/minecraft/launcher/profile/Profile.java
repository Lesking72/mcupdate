...
public class Profile implements Comparable<Profile>
{
    ...
    public static final String DEFAULT_JRE_ARGUMENTS_32BIT = "-Xmx512M -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M";
    ...
    public Profile(final Profile copy) {
        ...
        //this line decompiled by Procyon caused compile errors. The replacement is decompiled by JD-GUI
		//this.allowedReleaseTypes = (Set<MinecraftReleaseType>)((copy.allowedReleaseTypes == null) ? null : Sets.newHashSet((Iterable<?>)copy.allowedReleaseTypes));
