...
public class MinecraftGameRunner extends AbstractGameRunner implements GameProcessRunnable
{
    ...
    protected void launchGame() throws IOException {
        ...
        if (profileArgs != null) {
            ...
            final String defaultArgument = is32Bit ? "-Xmx512M -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M" : "-Xmx2G -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:G1NewSizePercent=20 -XX:G1ReservePercent=20 -XX:MaxGCPauseMillis=50 -XX:G1HeapRegionSize=32M";
    ...
    private void migrateOldAssets() {
		MinecraftGameRunner.LOGGER.error("Couldn't migrate old assets! decompiled code is broken");
		System.out.println("Old asset migration failed! (decompiled code is broken)");
