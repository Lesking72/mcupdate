...
public static final String URL_BLOG = "https://lesking72.github.io/mcupdate"; //Replace original blog with mine
...
public static final String[] LAUNCHER_OUT_OF_DATE_BUTTONS = { "Nevermind, close this launcher", "I'm sure. Reset my settings." };
...
try
{
return (LauncherProperties)gson.fromJson(IOUtils.toString(stream), LauncherProperties.class);
}
catch (IOException e)
{
e.printStackTrace();
...
{
PRODUCTION(""), STAGING(" (STAGING VERSION, NOT FINAL)"), DEV(" (DEV VERSION, NOT FINAL)");
...
{
private LauncherConstants.LauncherEnvironment environment = LauncherConstants.LauncherEnvironment.PRODUCTION;
